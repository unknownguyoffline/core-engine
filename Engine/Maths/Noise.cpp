...
// {
//     return glm::normalize(glm::vec2(RandomUnitFloat(), RandomUnitFloat()));
// }

// glm::vec3 RandomUnitVec3()
// {
//     return glm::normalize(glm::vec3(RandomUnitFloat(), RandomUnitFloat(), RandomUnitFloat()));
// }

// glm::vec3 RandomUnitVec4()
// {
//     return glm::normalize(glm::vec4(RandomUnitFloat(), RandomUnitFloat(), RandomUnitFloat(), RandomUnitFloat()));
// }
...
// glm::ivec2 RandomIVec2()
// {
//     return glm::normalize(glm::ivec2(RandomInt(), RandomInt()));
// }

// glm::ivec3 RandomIVec3()
// {
//     return glm::normalize(glm::ivec3(RandomInt(), RandomInt(), RandomInt()));
// }

// glm::ivec3 RandomIVec4()
// {
//     return glm::normalize(glm::ivec4(RandomInt(), RandomInt(), RandomInt(), RandomInt()));
// }
...
// glm::uvec2 RandomUIVec2()
// {
//     return glm::normalize(glm::uvec2(RandomUInt(), RandomUInt()));
// }

// glm::uvec3 RandomUIVec3()
// {
//     return glm::normalize(glm::uvec3(RandomUInt(), RandomUInt(), RandomUInt()));
// }

// glm::uvec3 RandomUIVec4()
// {
//     return glm::normalize(glm::uvec4(RandomUInt(), RandomUInt(), RandomUInt(), RandomUInt()));
// }